...
<div class="full-main">
  ...
  <div class="container">
    ...
    <div class="nav nav-pills d-flex flex-column flex-sm-row overflow-auto" role="tablist" style="height:51px;">
      ...
      <div class="nav-item">
        <a class="nav-link" data-bs-toggle="pill" href="#auditor">Auditor</a>
      </div>
      <div class="nav-item">
        <a class="nav-link" data-bs-toggle="pill" href="#g11rep">G-11 Representative</a>
      </div>
      <div class="nav-item">
        <a class="nav-link" data-bs-toggle="pill" href="#g12rep">G-12 Representative</a>
      </div>
    ...
    <div class="tab-content">
      ...
      <!--* VIEW ALL SECTION * * VIEW ALL SECTION * * VIEW ALL SECTION * -->
        <?php include 'shsCandidateContent/viewAll.php'; ?>
      <!--* VIEW ALL SECTION * * VIEW ALL SECTION * * VIEW ALL SECTION * -->

      <!--* PARTY LIST A SECTION * *  PARTY LIST A SECTION * *  PARTY LIST A SECTION * -->
        <?php include 'shsCandidateContent/partyListA.php'; ?>
       <!--* PARTY LIST A SECTION * *  PARTY LIST A SECTION * *  PARTY LIST A SECTION * -->

      <!--* PARTY LIST B SECTION * *  PARTY LIST A SECTION * *  PARTY LIST A SECTION * -->
        <?php include 'shsCandidateContent/partyListB.php'; ?>
       <!--* PARTY LIST B SECTION * *  PARTY LIST A SECTION * *  PARTY LIST A SECTION * -->

      <!--* PRESIDENT SECTION * * PRESIDENT SECTION * * PRESIDENT SECTION * -->
        <?php include 'shsCandidateContent/president.php'; ?>
      <!--* PRESIDENT SECTION * * PRESIDENT SECTION * * PRESIDENT SECTION * -->

      <!--*VICE PRESIDENT SECTION * *VICE PRESIDENT SECTION * *VICE PRESIDENT SECTION * -->
        <?php include 'shsCandidateContent/vicePresident.php'; ?>
      <!--*VICE PRESIDENT SECTION * *VICE PRESIDENT SECTION * *VICE PRESIDENT SECTION * -->

      <!--* SECRETARY SECTION * * SECRETARY SECTION * * SECRETARY SECTION * -->
        <?php include 'shsCandidateContent/secretary.php'; ?>
      <!--* SECRETARY SECTION * * SECRETARY SECTION * * SECRETARY SECTION * -->

      <!--* TREASURER SECTION * * TREASURER SECTION * * TREASURER SECTION * -->
        <?php include 'shsCandidateContent/treasurer.php'; ?>
      <!--* TREASURER SECTION * * TREASURER SECTION * * TREASURER SECTION * -->

      <!--* Auditor SECTION * * Auditor SECTION * * Auditor SECTION * -->
      <?php include 'shsCandidateContent/auditor.php'; ?>
      <!--* Auditor SECTION * * Auditor SECTION * * Auditor SECTION * -->

      <!--* shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * -->
        <?php include 'shsCandidateContent/grade11Representative.php'; ?>
      <!--* shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * -->

      <!--* shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * -->
      <?php include 'shsCandidateContent/grade12Representative.php'; ?>
      <!--* shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * * shs REPRESENTATIVES SECTION * -->
