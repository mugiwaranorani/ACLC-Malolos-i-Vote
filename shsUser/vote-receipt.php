        ...
        <div class="vote-container p-3 rounded" style="border: 3px solid;">
          ...
          <div class="container-fluid">
            ...
            <?php include '../dbconn.php';
              ...
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedPresident FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
            ...
            <?php include '../dbconn.php';
              $voterID = $_SESSION['voterID'];
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedVicePresident FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
            ...
            <?php include '../dbconn.php';
              $voterID = $_SESSION['voterID'];
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedSecretary FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
            ...
            <?php include '../dbconn.php';
              $voterID = $_SESSION['voterID'];
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedTreasurer FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
            ...
            <?php include '../dbconn.php';
              $voterID = $_SESSION['voterID'];
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedAuditor FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
            ...
            <?php include '../dbconn.php';
              $voterID = $_SESSION['voterID'];
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedShs11Representative FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
            ...
            <?php include '../dbconn.php';
              $voterID = $_SESSION['voterID'];
              $sql = "SELECT * FROM shs_candidates WHERE candidateID IN(SELECT confirmedShs12Representative FROM shs_confirmedvote WHERE voterID = '" . $voterID . "')";
              $result = $conn->query($sql);
