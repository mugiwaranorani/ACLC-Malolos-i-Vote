...
<div class="full-main" id="lockpage">
  ...
  <?php
    ...
    $query = "SELECT voterName FROM shs_pendingvote WHERE voterID = $voterID";
            ...
            <div id="positions" class="tab-pane fade show active"><br>
                ...
                <div class="con">
                    ...
                    <div class="box">
                      <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                      <div class="box-info">
                        <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="auditor" name="auditor" value="<?php echo $row['candidateID']?>" required></b></strong>
                        <br>
                        <b>Name: </b> <?php echo $row['name']?>
                      </div>
                    </div>
                ...
                <!--SHS 11 REPRESENTATIVE START-->
                <h5><i>GRADE 11 REPRESENTATIVE(S)</i></h5>
                <div class="con">
                    ...
                    <div class="box">
                      <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                      <div class="box-info">
                        <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="shs11rep" name="shs11rep" value="<?php echo $row['candidateID']?>" required></b></strong>
                        <br>
                        <b>Name: </b> <?php echo $row['name']?>
                      </div>
                    </div>
                ...
                <!--SHS 12 REPRESENTATIVE REPRESENTATIVE END-->
                <hr>
                <!--SHS REPRESENTATIVE START-->
                <h5><i>GRADE 12 REPRESENTATIVE(S)</i></h5>
                <div class="con">
                    ...
                    <div class="box">
                      <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                      <div class="box-info">
                        <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="shs12rep" name="shs12rep" value="<?php echo $row['candidateID']?>" required></b></strong>
                        <br>
                        <b>Name: </b> <?php echo $row['name']?>
                      </div>
                    </div>
                ...
                <!--SHS REPRESENTATIVE REPRESENTATIVE END-->
              ...
              <div id="plA" class="container tab-pane fade"><br>
                ...
                <form action="vote-pending-process.php" method="post"  enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="vid" value="<?php echo $_SESSION['voterID'];?>">
                    ...
                    <div class="con">
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='PRESIDENT'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='VICE PRESIDENT'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='SECRETARY'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='TREASURER'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='AUDITOR'";
                        $result = $conn->query($sql);
                      ...
                      <div class="box mb-4">
                        <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                        <div class="box-info">
                          <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="auditorA" name="auditorA" value="<?php echo $row['candidateID']?>" checked></b></strong>
                          <br>
                          <b>Name: </b> <?php echo $row['name']?>
                        </div>
                      </div>
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='G-11 REP'";
                        $result = $conn->query($sql);
                      ...
                      <div class="box mb-4">
                        <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                        <div class="box-info">
                          <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="shs11repA" name="shs11repA" value="<?php echo $row['candidateID']?>" checked></b></strong>
                          <br>
                          <b>Name: </b> <?php echo $row['name']?>
                        </div>
                      </div>
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST A' AND position ='G-12 REP'";
                        $result = $conn->query($sql);
                      ...
                      <div class="box mb-4">
                        <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                        <div class="box-info">
                          <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="shs12repA" name="shs12repA" value="<?php echo $row['candidateID']?>" checked></b></strong>
                          <br>
                          <b>Name: </b> <?php echo $row['name']?>
                        </div>
                      </div>
                ...
                <h5><i>PARTY LIST B</i></h5>
                  <form action="vote-pending-process.php" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="con">
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='PRESIDENT'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='VICE PRESIDENT'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';  
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='SECRETARY'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';  
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='TREASURER'";
                        $result = $conn->query($sql);
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='AUDITOR'";
                        $result = $conn->query($sql);
                      ...
                      <div class="box mb-4">
                        <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                        <div class="box-info">
                          <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="auditorB" name="auditorB" value="<?php echo $row['candidateID']?>" checked></b></strong>
                          <br>
                          <b>Name: </b> <?php echo $row['name']?>
                        </div>
                      </div>
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='G-11 REP'";
                        $result = $conn->query($sql);
                      ...
                      <div class="box mb-4">
                        <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                        <div class="box-info">
                          <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="shs11repB" name="shs11repB" value="<?php echo $row['candidateID']?>" checked></b></strong>
                          <br>
                          <b>Name: </b> <?php echo $row['name']?>
                        </div>
                      </div>
                      ...
                      <?php include '../dbconn.php';
                        $sql = "SELECT * FROM shs_candidates WHERE partyList ='PARTY LIST B' AND position ='G-12 REP'";
                        $result = $conn->query($sql);
                      ...
                      <div class="box mb-4">
                        <img src="../uploads/<?php echo $row['picture']?>" alt="sc candidate" width="96" height="96">
                        <div class="box-info">
                          <strong><b class="fs-5"><?php echo $row['position']?> <input type="radio" id="shs12repB" name="shs12repB" value="<?php echo $row['candidateID']?>" checked></b></strong>
                          <br>
                          <b>Name: </b> <?php echo $row['name']?>
                        </div>
                      </div>
