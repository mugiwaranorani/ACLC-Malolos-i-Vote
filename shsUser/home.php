...
<div class="full-main">
  ...
  <?php include 'userSettingsModals/modalLogoutConfirmation.php'; ?>
      ...
      <div class="container p-3">
        ...
        <?php			
          include ('../dbconn.php');
          $sql = "SELECT * FROM shs_title WHERE titlePage='Home'";
          ...
          <div class="tab-content">
            ...
            <div id="informations" class="tab-pane fade show active"><br>
              <div class="container home-content text-start p-4 px-sm-5 fs-5">
                ...
                <?php			
                  include ('../dbconn.php');
                  $sql = "SELECT * FROM shs_home WHERE homecontentID = 'information'";
                  $result = $conn->query($sql);
            ...
            <div id="announcements" class="tab-pane fade"><br>
              <div class="container home-content text-start p-4 px-sm-5 fs-5">
                <h2 class="user-greeting"><img src="ACLCLOGO/logo3.jpeg" alt="School Logo" style="width: 26px;"><strong><b> Announcements</b></strong></h2>
                    ...
                    <h4><img src="ACLCLOGO/sclogo2.png" alt="School Logo" style="width: 32px; margin-bottom: 5px;"> <b>Student Council Winners</b> <img src="ACLCLOGO/logo3.jpeg" alt="School Logo" style="width: 26px; margin-bottom: 5px;"></h4>
                      ...
                      <div class="con">
                        ...
                        ?>
                          <div class="card card_size" style="height: 500px; width: 500px;">
                            ...
                            <div class="card-body">
                              ...
                              <!--MODAL PROFILE-->
                              <?php include 'shsCandidateModals/president-Modal.php'; ?>
                              <!--MODAL PROFILE-->
                            </div>
                          </div>
                        <?php
                        ...
                        ?>
                          <div class="card card_size" style="height: 500px; width: 500px;">
                            ...
                            <div class="card-body">
                              ...
                              <!--MODAL PROFILE-->
                              <?php include 'shsCandidateModals/secretary-Modal.php'; ?>
                              <!--MODAL PROFILE-->
                            </div>
                          </div>
                        <?php
                        ...
                        ?>
                          <div class="card card_size" style="height: 500px; width: 500px;">
                            ...
                            <div class="card-body">
                              ...
                              <!--MODAL PROFILE-->
                              <?php include 'shsCandidateModals/treasurer-Modal.php'; ?>
                              <!--MODAL PROFILE-->
                            </div>
                          </div>
                        <?php
                        ...
                        <?php
                          ...
                          // Retrieve the candidate with the highest count for Vice President
                          $sql = "SELECT * FROM shs_candidates WHERE position = 'AUDITOR' ORDER BY voteCount DESC LIMIT 1";
                          $result = $conn->query($sql);
                        ...
                        ?>
                          <div class="card card_size" style="height: 500px; width: 500px;">
                            ...
                            <div class="card-body">
                              <h4 class="card-title"><b><?php echo $row['position']?></b></h4>
                              <p class="card-text">Name: <?php echo $row['name']?></p>
                              <button data-bs-toggle="modal" data-bs-target="#auditorModal<?php echo $row['candidateID']?>" class="btn btn-primary" data-id="<?php echo $row['candidateID']?>">See profile</button>
                              <!--MODAL PROFILE-->
                              <?php include 'shsCandidateModals/auditor-Modal.php'; ?>
                              <!--MODAL PROFILE-->
                            </div>
                          </div>
                        <?php
                        ...
                        <?php
                          ...
                          // Retrieve the candidate with the highest count for Vice President
                          $sql = "SELECT * FROM shs_candidates WHERE position = 'GRADE-11 REP' ORDER BY voteCount DESC LIMIT 1";
                          $result = $conn->query($sql);
                        ...
                        ?>
                          <div class="card card_size" style="height: 500px; width: 500px;">
                            ...
                            <div class="card-body">
                              <h4 class="card-title"><b><?php echo $row['position']?></b></h4>
                              <p class="card-text">Name: <?php echo $row['name']?></p>
                              <button data-bs-toggle="modal" data-bs-target="#grade11RepModal<?php echo $row['candidateID']?>" class="btn btn-primary" data-id="<?php echo $row['candidateID']?>">See profile</button>
                              <!--MODAL PROFILE-->
                              <?php include 'shsCandidateModals/grade11Representative-Modal.php'; ?>
                              <!--MODAL PROFILE-->
                            </div>
                          </div>
                        <?php
                        ...
                        <?php
                          ...
                          // Retrieve the candidate with the highest count for Vice President
                          $sql = "SELECT * FROM shs_candidates WHERE position = 'GRADE-12 REP' ORDER BY voteCount DESC LIMIT 1";
                          $result = $conn->query($sql);
                  ...
                  <?php include '../shsWinnerResult.php'; ?>
