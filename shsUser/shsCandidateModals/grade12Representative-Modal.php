<!--Modal Profile -->
<div class="modal fade" id="grade12RepModal<?php echo $row['candidateID']?>">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <img class="card-img-top modal-img " src="../uploads/<?php echo $row['picture']?>" alt="candidate image" style="width: 300px;">
            <br>
          ...
          <div class="content-text">
            <div class="text-profile">
              ...
              <strong>Grade:</strong> <?php echo $row['yearLvl']?><br>
              <strong>Strand:</strong> <?php echo $row['strand']?><br>
