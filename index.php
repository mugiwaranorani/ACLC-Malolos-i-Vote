...
<html lang="en">
  ...
  <body class="portal-body">
    ...
    <div class="container-fluid col-sm-12">
      ...
      <div class="content-style container d-flex align-items-center justify-content-center text-center rounded text-light  mb-2 mt-2">
        ...
        <div class="portalBg-height">
          <div class="main_content portal-bg container bg-primary text-white rounded line-shadow p-3" style="opacity: 0.8;">
      ...
      <div class="fixed-absolute mt-2 content-style container text-white d-flex-column align-items-center justify-content-center text-center rounded p-1">
        <br>
        <h4>© i-Voting System <img src="admin/ACLCLOGO/logo3.jpeg" alt="School Logo" style="width:25px;"> ACLC College of Malolos 2023 All Rights Reserved</h4><p> .Web Developer: BSCS-42CC (S.Y 2022-2023).</p>
      </div>
