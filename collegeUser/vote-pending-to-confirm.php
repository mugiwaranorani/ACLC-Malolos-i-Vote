          ...
          <div class="vote-container p-3 rounded mb-3" style="border: 3px solid;">
            <div class="container-fluid text-danger" style="margin-left:-8px;"><h4>NOTICE: Please check your selected candidates before confirming... </h4><br></div>
              ...
              <?php include '../dbconn.php';
                $voterID = $_SESSION['voterID'];
                $sql = "SELECT * FROM clg_candidates WHERE candidateID IN(SELECT pendingPresident FROM clg_pendingvote WHERE voterID = '" . $voterID . "')";
                $result = $conn->query($sql);
              ...
              <?php include '../dbconn.php';
                $voterID = $_SESSION['voterID'];
                $sql = "SELECT * FROM clg_candidates WHERE candidateID IN(SELECT pendingVicePresident FROM clg_pendingvote WHERE voterID = '" . $voterID . "')";
                $result = $conn->query($sql);
              ...
              <?php include '../dbconn.php';
                $voterID = $_SESSION['voterID'];
                $sql = "SELECT * FROM clg_candidates WHERE candidateID IN(SELECT pendingSecretary FROM clg_pendingvote WHERE voterID = '" . $voterID . "')";
                $result = $conn->query($sql);
              ...
              <?php include '../dbconn.php';
                $voterID = $_SESSION['voterID'];
                $sql = "SELECT * FROM clg_candidates WHERE candidateID IN(SELECT pendingTreasurer FROM clg_pendingvote WHERE voterID = '" . $voterID . "')";
                $result = $conn->query($sql);
              ...
              <?php include '../dbconn.php';
                $voterID = $_SESSION['voterID'];
                $sql = "SELECT * FROM clg_candidates WHERE candidateID IN(SELECT pendingCollegeRepresentative FROM clg_pendingvote WHERE voterID = '" . $voterID . "')";
                $result = $conn->query($sql);
