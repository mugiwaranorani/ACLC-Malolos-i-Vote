          ...
          <div class="tab-pane fade show active p-3">
            ...
            <hr>
              ...
              <div class="nav nav-pills d-flex flex-column flex-sm-row overflow-auto" role="tablist" style="height:51px;">
                ...
                <div class="nav-item">
                  <a class="nav-link" href="../../../college.php">Data Reports</a>
                </div>
                <div class="nav-item">
                  <a class="nav-link" href="userLog.php">User Log</a>
                </div>
                <div class="nav-item">
                  <a class="nav-link active" href="voteLog.php">Vote Log</a>
                </div>
            ...
            <div class="containter-fluid overflow-auto" style="height: 403px;">
                ...
                <?php
                    $sql = "SELECT * FROM shs_confirmedvote WHERE voterName LIKE '%{$search}%' OR dateConfirmedVote LIKE '%{$search}%'";
                ...
                ?>
                    <div class="container rounded line-shadow p-3 mb-4">
                      ...
                      <a class="btn btn-outline-danger" href="voteLog.php">Clear Search</a>
                    </div>
                    ...
                    <div class="container container-hover line-shadow rounded d-flex justify-content-between mb-2 p-3">
                      <div class="fs-2">
                        <i class='fas fa-user-circle' style='font-size:50px'></i> <?php echo $row['voterName'];?> (Voted)
                      </div>
                      <div class="fs-6">
                        <?php echo $row['dateConfirmedVote'];?>
                      </div>
                    </div>
                ...
                <?php
                  ...
                  $query=mysqli_query($conn,"SELECT * FROM shs_confirmedvote");
                  
                  while($row=mysqli_fetch_array($query)) {
                ?>
                <div class="container container-hover line-shadow rounded mb-2 p-3">
