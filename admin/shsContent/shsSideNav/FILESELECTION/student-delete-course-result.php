            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <?php
                    include '../../../../dbconn.php';
                    if(isset($_POST['deleteCourseInfoBtn'])){
                      $id = $_POST['id'];

                      $sql = "DELETE FROM shs_strandselection WHERE strandID = $id";
                      
                      if ($conn->query($sql) === TRUE) {
                  ?>
                      
                      <i><h2 class="text-success">Strand has been deleted successfully!</i></h2>
