          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> EDIT POSITION (SELECTION)</h3>
                <hr>
                  
                  <form action="candidate-edit-position-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="positionSelect" maxlength="14" name="positionSelect" placeholder="title here" value="<?php echo $row['position']?>" required>
                    ...
                    <input type="submit"  name="editPosInfoBtn" class="btn btn-success px-4" value="Save">
