      ...
      <div class="col-sm-3 p-2">
        ...
        <div class="nav nav-pills flex-column bg-dark p-3 rounded" role="tablist">
          ...
          <div class="container-fluid overflow-auto" style="height: 550px;"> <!-- overflow-auto" style="height: 550px;" (insert inside if needed<--------------) -->
            ...
            <h5 class="text-secondary">FILE SELECTION</h5>
            <div class="nav-item">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> ADD STRAND (SELECTION)</h3>
                <hr>
                  
                  <form action="student-add-course-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="courseSelect" maxlength="70" name="courseSelect" placeholder="title here" value="" required>
                      <label for="floatingInput">Strand <span class="text-danger">(70)</span>:</label>
                    </div>

                    <input type="submit"  name="addCourseInfoBtn" class="btn btn-success px-4" value="Add Content">
                    <a class="btn btn-danger px-4" href="student-selectionControl.php">Cancel</a>
