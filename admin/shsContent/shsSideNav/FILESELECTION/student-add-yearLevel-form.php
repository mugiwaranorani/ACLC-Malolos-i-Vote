          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> ADD YEAR LEVEL (SELECTION)</h3>
                <hr>
                  
                  <form action="student-add-yearLevel-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="yearLevelSelect" maxlength="20" name="yearLevelSelect" placeholder="title here" value="" required>
                      <label for="floatingInput">Year Level <span class="text-danger">(20)</span>:</label>
                    </div>

                    <input type="submit"  name="addYlInfoBtn" class="btn btn-success px-4" value="Add Content">
