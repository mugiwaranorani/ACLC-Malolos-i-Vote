            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                    ...
                    <?php
											include '../../../../dbconn.php';
											if (isset($_POST['addYlInfoBtn'])) {
											$yearLevelSelection = $_POST['yearLevelSelect'];

											$sql = "INSERT INTO shs_ylselection (`yearLevel`)
											VALUES ('$yearLevelSelection')";
											
											if ($conn->query($sql)) {?>
											
												<i><h2 class="text-success">New year level has been added to selection successfully!</i></h2>
										...
										?>
											...
											<a class="btn btn-primary px-4 mt-2" href="student-selectionControl.php">BACK</a>
