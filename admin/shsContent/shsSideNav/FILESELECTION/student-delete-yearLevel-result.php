            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <?php
                    include '../../../../dbconn.php';
                    if(isset($_POST['deleteYlInfoBtn'])){
                      $id = $_POST['id'];

                      $sql = "DELETE FROM shs_ylselection WHERE yearLevelID = $id";
                      
                      if ($conn->query($sql) === TRUE) {
                  ?>
                      
                      <i><h2 class="text-success">Year level has been deleted successfully!</i></h2>
