          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> DELETE YEAR LEVEL (SELECTION)</h3>
                <hr>
                    <?php			
                      include ('../../../../dbconn.php');
                      $id = $_REQUEST['id'];
                    ...
                    ?>
                    <span class='text-danger fs-5'>Are you sure you want to delete <span class="text-secondary fs-4 mt-2">"<?php echo $row['yearLevel']?>"</span> from year level selection?</span>
                    <?php	
                      }		
                      $conn->close();
                      }
                    ?> 
                    <form action="student-delete-yearLevel-result.php" method='post'>
                      <input class='btn btn-primary' type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>">
                      <button class="btn btn-success px-4 m-1" name="deleteYlInfoBtn">Yes</button>
                      <a class='btn btn-danger m-1 px-4' href='student-selectionControl.php'>No</a>
                    </form>
