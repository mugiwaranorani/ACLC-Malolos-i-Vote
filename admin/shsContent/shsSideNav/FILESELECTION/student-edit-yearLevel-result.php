              ...
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <form action="#" method="post">
                    ...
                    <?php			
                      include ('../../../../dbconn.php');
                      $yearLevel = $_POST['yearLevelSelect'];
                      $id = $_REQUEST['id'];
                      $sql = "UPDATE `shs_ylselection` SET `yearLevel`='$yearLevel' WHERE yearLevelID = $id";
                      $result = $conn->query($sql);
                              
                      if ($result > 0) {
                    ?>

                      <i><h2 class="text-success">Year level has been updated successfully!</i></h2>
