            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                    ...
                    <?php
											include '../../../../dbconn.php';
											if (isset($_POST['addCourseInfoBtn'])) {
											$strand = $_POST['courseSelect'];

											$sql = "INSERT INTO shs_strandselection (`strand`)
											VALUES ('$strand')";
											
											if ($conn->query($sql)) {?>
											
												<i><h2 class="text-success">New strand has been added to selection successfully!</i></h2>
