            ...
            <div class="container-fluid overflow-auto text-center" style="height: 560px;">
              ...
              <div class="col-sm-12 p-2">
                <div class="container home-content p-3">
                  <h2><b><i class='fas fa-file' style='font-size:28px'></i> STRAND SELECTION</b></h2>
                  <hr>
                    ...
                    <table class="table table-responsive table-info home-content table-hover table-secondary rounded text-center overflow-hidden">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th><a class="btn btn-primary px-4" href="student-edit-course-form.php?id='<?php echo $row['strandID']?>'">Edit</a></th>
                          <th><a class="btn btn-danger px-3" href="student-delete-course.php?id='<?php echo $row['strandID']?>'">Delete</a></th>
                        </tr>
                        <?php
                        ...
                        <form action="student-add-course-form.php" method="post">
                          <button class="btn btn-outline-primary d-flex flex-row-start">Add New Strand</button>
                        </form>
                        <br>
                      </tbody>
                    </table>
