...
<title>Admin SHS</title>
  <link rel="icon" type="image/x-icon" href="../../../../shs/ACLCLOGO/logo3.jpeg">
    <style>
      .line-shadow{
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> ADD PARTY LIST (SELECTION)</h3>
                <hr>
                  
                  <form action="candidate-add-partyList-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="partyListSelect" name="partyListSelect" placeholder="title here" value="" maxlength="20" required>
                      <label for="floatingInput">Party List <span class="text-danger">(20)</span>:</label>
                    </div>

                    <input type="submit"  name="addPlInfoBtn" class="btn btn-success px-4" value="Add Content">
                    <a class="btn btn-danger px-4" href="candidate-selectionControl.php">Cancel</a>
