    ...
    <div class="row">
      <div class="col-sm-3 p-2">
        ...
        <div class="nav nav-pills flex-column bg-dark p-3 rounded" role="tablist">
          ...
          <div class="container-fluid overflow-auto" style="height: 550px;"> <!-- overflow-auto" style="height: 550px;" (insert inside if needed<--------------) -->
            ...
            <div class="nav-item">
              <a class="nav-link active" href="student-selectionControl.php"><i class='fas fa-file' style='font-size:18px'></i> Student's Year Level & Strand</a>
            </div>
            <hr class="text-secondary">
            <!--FILE SELECTION END-->
      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            <h1><strong><b><i><i class='fas fa-file' style='font-size:40px'></i> FILE - YEAR LEVEL AND STRAND</i></strong></b></h1>
            <hr>
            <div class="container-fluid overflow-auto" style="height: 560px;">
            <br>
              <div class="container line-shadow p-3">

                <h3><i class='fas fa-file' style='font-size:30px'></i> EDIT YEAR LEVEL (SELECTION)</h3>
                <hr>
                  
                  <form action="student-edit-yearLevel-result.php" method="post">
                    ...
                    <?php			
                      include ('../../../../dbconn.php');
                      $id = $_REQUEST['id'];
                      $sql = "SELECT * FROM shs_ylselection WHERE yearLevelID = $id";
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="yearLevelSelect" maxlength="20" name="yearLevelSelect" placeholder="title here" value="<?php echo $row['yearLevel']?>" required>
                      <label for="floatingInput">Position <span class="text-danger">(20)</span>:</label>
                    </div>
                    ...
                    <input type="submit"  name="editYLInfoBtn" class="btn btn-success px-4" value="Save">
                    <a class="btn btn-danger px-3" href="student-selectionControl.php">Cancel</a>
