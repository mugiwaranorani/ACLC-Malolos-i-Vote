            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                    ...
                    <?php
											include '../../../../dbconn.php';
											if (isset($_POST['addPosInfoBtn'])) {
											$positionSelection = $_POST['positionSelect'];

											$sql = "INSERT INTO shs_positionselection (`position`)
											VALUES ('$positionSelection')";
											
											if ($conn->query($sql)) {?>
											
												<i><h2 class="text-success">New position has been added to selection successfully!</i></h2>
