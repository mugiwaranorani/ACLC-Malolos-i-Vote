            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                    ...
                    <?php
											include '../../../../dbconn.php';
											if (isset($_POST['addPlInfoBtn'])) {
											$partyListSelection = $_POST['partyListSelect'];

											$sql = "INSERT INTO shs_plselection (`partyList`)
											VALUES ('$partyListSelection')";
											
											if ($conn->query($sql)) {?>
											
												<i><h2 class="text-success">New party list has been added to selection successfully!</i></h2>
										...
										?>
											...
											<a class="btn btn-primary px-4 mt-2" href="candidate-selectionControl.php">BACK</a>
