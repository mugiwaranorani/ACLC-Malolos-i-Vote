          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> EDIT COURSE (SELECTION)</h3>
                <hr>
                  
                  <form action="student-edit-course-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="courseSelect" maxlength="70" name="courseSelect" placeholder="title here" value="<?php echo $row['strand']?>" required>
                      <label for="floatingInput">Position <span class="text-danger">(70)</span>:</label>
                    </div>
                    ...
                    <input type="submit"  name="editCourseInfoBtn" class="btn btn-success px-4" value="Save">
