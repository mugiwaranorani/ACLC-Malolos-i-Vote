          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> STRAND (SELECTION)</h3>
                <hr>
                  ...
                  <form action="#" method="post">
                    ...
                    <?php			
                      ...
                      $id = $_REQUEST['id'];
                      $sql = "UPDATE `shs_strandselection` SET `strand`='$strand' WHERE strandID = $id";
                      $result = $conn->query($sql);
                              
                      if ($result > 0) {
                    ?>

                      <i><h2 class="text-success">Strand has been updated successfully!</i></h2>
