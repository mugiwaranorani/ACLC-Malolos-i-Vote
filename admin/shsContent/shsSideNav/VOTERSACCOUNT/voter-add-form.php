          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto" style="height: 560px;">
              ...
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-user-plus' style='font-size:30px'></i> ADD NEW VOTER ACCOUNT</h3>
                <hr>
                  
                  <form action="voter-add-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="fname" maxlength="30" name="fname" placeholder="title here" value="" required>
                    ...
                    <?php			
                      ...
                      $sql = "SELECT * FROM shs_ylselection";
                    ...
                    <?php			
                      include ('../../../../dbconn.php');
                      //DB QUERY FOR COURSE SELECTION OUTPUT
                      $sql = "SELECT * FROM shs_strandselection";
                      $result = $conn->query($sql);
                    ?>
                    <div class="form-floating">
                      ...
                      <label for="floatingCourse">Strand: <span class="text-danger">(Select)</span>:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="usn" maxlength="15" name="usn" placeholder="title here" value="" required>
                      <label for="floatingInput">USN <span class="text-danger">(15)</span>:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="voterpassword" maxlength="20" name="voterpassword" placeholder="title here" value="" required>
                      <label for="floatingInput">Password <span class="text-danger">(20)</span>:</label>
                    </div>

                    <input type="submit"  name="addVoterAccountBtn" class="btn btn-success px-4" value="Add New Account">
