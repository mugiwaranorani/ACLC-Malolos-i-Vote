                ...
                <hr>
                  ...
                  <form action="#" method="post">
                    ...
                    <?php			
                      ...
                      $id = $_REQUEST['id'];
                      $sql = "UPDATE `shs_voter` SET `fullName`='$fname', `yearLevel`='$yl', `strand`='$strand', `usn`='$usn', `vpass`='$voterpassword' WHERE voterID = $id";
                      $result = $conn->query($sql);
                              
                      if ($result > 0) {
                    ?>

                      <i><h2 class="text-success">Account has been updated successfully!</i></h2>
