            ...
            <div class="container-fluid overflow-auto" style="height: 448px;">
              ...
              <?php
                if (isset($_POST['searchbtn'])) {
                  ...
                  $sql = "SELECT * FROM shs_voter WHERE voterID LIKE '%{$search}%' OR fullName LIKE '%{$search}%' OR usn LIKE '%{$search}%' OR course LIKE '%{$search}%' OR yearLevel LIKE '%{$search}%' OR email LIKE '%{$search}%' OR voteStatus LIKE '%{$search}%'";
