    ...
    <div class="row">
      <div class="col-sm-3 p-2">
        ...
        <div class="nav nav-pills flex-column bg-dark p-3 rounded" role="tablist">
          ...
          <div class="container-fluid overflow-auto" style="height: 550px;"> <!-- overflow-auto" style="height: 550px;" (insert inside if needed<--------------) -->
            ...
            <div class="nav-item">
              <a class="nav-link active" href="titleControl.php"><i class="fa fa-book" style="font-size:18px"></i> Election Title</a>
            </div>
            <div class="nav-item">
      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            <h1><strong><b><i><i class='fa fa-book' style='font-size:50px'></i> ELECTION TITLES</i></strong></b></h1>
            <hr>
            <div class="container-fluid overflow-auto rounded p-2" style="height: 550px;">
              
              <div class="">
                <div class="container line-shadow rounded mb-4 p-2">
                  <h2 style="margin-left: 10px;"><i class='fa fa-book' style='font-size:30px'></i> <i>HOME PAGE TITLE</i></h2>
                  <hr>
                    <?php			
                      include ('../../../../dbconn.php');
                    ...
                    ?>
                    <h3 class="p-2"><strong><b><?php echo $row['title']?></strong></b></h3>
                      <div class="d-flex flex-row-reverse">
                        <a class="btn btn-primary m-1 fs-5 px-5" href="title-edit.php?id='<?php echo $row['titlePage']?>'">Edit</a>
                      </div>
                    <?php	
                    }		
                    $conn->close();
              ...
              <div class="">
                <div class="container line-shadow rounded mb-4 p-2">
                  <h2 style="margin-left: 10px;"><i class='fa fa-book' style='font-size:30px'></i> <i>CANDIDATES PAGE TITLE</i></h2>
                  <hr>
                    <?php			
                      include ('../../../../dbconn.php');
                      $sql = "SELECT * FROM shs_title WHERE titlePage='Candidates'";
                      $result = $conn->query($sql);
              ...
              <div class="">
                <div class="container line-shadow rounded mb-4 p-2">
                  <h2 style="margin-left: 10px;"><i class='fa fa-book' style='font-size:30px'></i> <i>VOTE PAGE TITLE</i></h2>
                  <hr>
                    <?php			
                      include ('../../../../dbconn.php');
              ...
              <div class="">
                <div class="container line-shadow rounded p-2">
                  <h2 style="margin-left: 10px;"><i class='fa fa-book' style='font-size:30px'></i> <i>RESULT PAGE TITLE</i></h2>
                  <hr>
                    <?php			
                      include ('../../../../dbconn.php');
