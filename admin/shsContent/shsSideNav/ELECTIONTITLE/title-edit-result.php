                ...
                <form action="title-edit-result.php" method="post">
                  ...
                  ?>
                    ...
                    <?php			
                      ...
                      $id = $_REQUEST['id'];
                      $sql = "UPDATE `shs_title` SET `title`='$Title' WHERE titlePage = $id";
                      $result = $conn->query($sql);
                              
                      if ($result > 0) {
                    ?>

                      <i><h2 class="text-success">Title has been updated successfully!</i></h2>
                    ...
                    <a class="btn btn-primary px-4 mt-1" href="titleControl.php">Back</a>
