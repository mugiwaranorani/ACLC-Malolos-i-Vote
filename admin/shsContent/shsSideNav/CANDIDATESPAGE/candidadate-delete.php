          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto" style="height: 560px;">
              ...
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fa fa-user-times' style='font-size:30px'></i> DELETE CANDIDATE</h3>
                <hr>
                  ...
                  ?>
                    <span class='text-danger fs-5'>Are you sure you want to delete <span class="text-secondary fs-4">"<?php echo $row['position']?> <?php echo $row['name']?>"</span> from candidates?</span>
                    <?php	
                      }		
                      $conn->close();
                      }
                  ?> 
                    <form action="candidate-delete-result.php" method='post'>
                      <input class='btn btn-primary' type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>">
                      <button class="btn btn-success px-4 m-1 mt-2" name="deleteCandidateBtn">Yes</button>
                      <a class='btn btn-danger px-4 m-1 mt-2' href='candidatesControl.php'>No</a>
                    </form>
