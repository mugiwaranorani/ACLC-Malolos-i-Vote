                  ...
                  if (isset($_POST['editCandidateBtn'])) {
                      ...
                      if (!empty($image)) {
                          ...
                          if (move_uploaded_file($image_tmp, $target_path)) {
                              ...
                              $id = $_REQUEST['id'];
                              $sql = "UPDATE `shs_candidates` SET `picture`='$image', `name`='$fname', `position`='$position', `partyList`='$partyList', `yearLvl`='$yearLevel', `strand`='$strand', `platform`='$platform' WHERE candidateID = $id";
                          ...
                          $id = $_REQUEST['id'];
                          $sql = "UPDATE `shs_candidates` SET `name`='$fname', `position`='$position', `partyList`='$partyList', `yearLvl`='$yearLevel', `strand`='$strand', `platform`='$platform' WHERE candidateID = $id";
                          $result = $conn->query($sql);
