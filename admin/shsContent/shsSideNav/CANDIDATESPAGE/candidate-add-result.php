      ...
      <div class="col-sm-3 p-2">
        ...
        <div class="nav nav-pills flex-column bg-dark p-3 rounded" role="tablist">
          ...
          <div class="container-fluid overflow-auto" style="height: 550px;"> <!-- overflow-auto" style="height: 550px;" (insert inside if needed<--------------) -->
            ...
            <div class="nav-item">
              <a class="nav-link active" href="../CANDIDATESPAGE/candidatesControl.php"><i class="fas fa-id-card" style="font-size:18px"></i> Candidates</a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="votersControl.php"><i class="fa fa-group" style="font-size:18px"></i> Voters Account</a>
            </div>
            <hr class="text-secondary">
            <!--MANAGE END-->
                ...
                <hr>
                    ...
                    if (isset($_POST['addCandidateBtn'])) {
                        ...
                        if (move_uploaded_file($image_tmp, $target_path)) {
                            ...
                            $sql = "INSERT INTO shs_candidates (name, position, partyList, yearLvl, strand, platform, picture)
                                    VALUES ('$fname', '$position', '$partyList', '$yearLevel', '$strand', '$platform', '$image')";

                            if ($conn->query($sql) === TRUE) {
                                // Query executed successfully
                    ?>
                                <i><h2 class="text-success">New Candidate has been added successfully!</i></h2>
                    <?php
                            } else {
                                echo "Error: " . $sql . "<br>" . $conn->error;
                            }
                        } else {
                            // File move encountered an error
                            echo "Please upload photo..<br>";
