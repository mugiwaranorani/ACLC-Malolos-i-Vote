          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">
                ...
                <h3><i class='fas fa-file-alt' style='font-size:30px'></i> ADD ANNOUNCEMENT TITLE AND CONTENT</h3>
                <hr>
                  
                  <form action="announcements-Add-Result.php" method="post" enctype="multipart/form-data">

                    <input type="hidden" class="form-control" id="hiddenannounceID" name="hiddenannounceID" placeholder="title here" value="announcement">
                    
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="announcecontentheader" name="announcecontentheader" placeholder="title here" value="" required>
                      <label for="floatingInput">Header Title:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <textarea class="form-control" placeholder=">Write you content here" id="announcecontent" name="announcecontent" style="height: 200px" required></textarea>
                    ...
                    <input type="submit"  name="addannounceBtn" class="btn btn-success px-4" value="Add Content">
