            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">        
                ...
                <hr>
                  ...
                  <?php
                    include '../../../../dbconn.php';
                    if(isset($_POST['deleteHomeInfoBtn'])){
                      $id = $_POST['id'];

                      $sql = "DELETE FROM shs_home WHERE homeID = $id";
                      
                      if ($conn->query($sql) === TRUE) {
                  ?>
                      
                      <i><h2 class="text-success">Information content has been deleted successfully!</i></h2>
