    ...
    <div class="row">
      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto p-1" style="height: 510px;">
              
              <div class="container home-content p-3">
                  
								<h3><i class='fas fa-file-alt' style='font-size:30px'></i> ADD SYSTEM GUIDE TITLE AND CONTENT</h3>
                <hr>
                  
                  <form action="systemGuide-Add-Result.php" method="post"  enctype="multipart/form-data">

                    <input type="hidden" class="form-control" id="hiddenguideID" name="hiddenguideID" placeholder="title here" value="systemGuide">

                    <?php			
                      include ('../../../../dbconn.php');
                      $sql = "SELECT * FROM shs_deviceguide";
                      $result = $conn->query($sql);
                    ?>
                    <div class="form-floating">
                      <select class="form-select form-select-md mb-3" aria-label=".form-select-lg example" name="deviceType">
                      ...
                      <label for="floatingYearLevel">Device Type: <span class="text-danger">(Select)</span>:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="guidecontentheader" name="guidecontentheader" placeholder="title here" value="" required>
                      <label for="floatingInput">Header Title:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <textarea class="form-control" placeholder=">Write you content here" id="guidecontent" name="guidecontent" style="height: 200px" required></textarea>
                    ...
                    <input type="submit"  name="addguideBtn" class="btn btn-success px-4" value="Add Content">
                    <a class="btn btn-danger px-4" href="systemGuide.php">Cancel</a>
