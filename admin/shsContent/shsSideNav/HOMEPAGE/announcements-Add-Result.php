            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">
                ...
                <?php
                  if (isset($_POST['addannounceBtn'])) {
                      ...
                      if (!empty($image)) {
                          ...
                          if (move_uploaded_file($image_tmp, $target_path)) {
                              ...
                              $hcontentID = $_POST['hiddenannounceID'];
                              $contentHeader = $_POST['announcecontentheader'];
                              $content = $_POST['announcecontent'];
                              $contentHeader = str_replace('\'', '’', $contentHeader);
                              $content = str_replace('\'', '’', $content);

                              $sql = "INSERT INTO shs_home (homecontentID, contentHeader, content, homeImages)
                                      VALUES ('$hcontentID','$contentHeader', '$content', '$image')";

                              if ($conn->query($sql) === TRUE) {
                                  // Query executed successfully
                                  ?>
                                  <i><h2 class="text-success">New Announcement content has been added successfully!</i></h2>
                                  <?php
                              } else {
                          ...
                          $sql = "INSERT INTO shs_home (homecontentID, contentHeader, content)
                                  VALUES ('$hcontentID','$contentHeader', '$content')";
                  ...
                  <a class="btn btn-primary px-4 mt-2" href="announcements.php">BACK</a>
