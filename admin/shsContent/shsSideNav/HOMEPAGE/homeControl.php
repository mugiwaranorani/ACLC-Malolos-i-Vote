          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">
                  <h3 class="user-greeting"><img src="../../../ACLCLOGO/logo3.jpeg" alt="School Logo" style="width: 26px;"><strong><b> HELLO, </b> <b style="text-transform: uppercase;">(User)</b>!</strong></h3>
                    <hr>
                      <?php			
                        include ('../../../../dbconn.php');
                        ...
                        <?php echo $imageVisibility ?>
                          <div class="d-flex flex-row-reverse">
                            <form action="#" methd="POST">
                              <a class="btn btn-primary px-4" href="information-Edit.php?id='<?php echo $row['homeID']?>'">Edit</a>
                              <a class="btn btn-danger px-3" href="information-Delete.php?id='<?php echo $row['homeID']?>'">Delete</a>
                            </form>
                          </div>
                      </div>
                      ...
                      <form action="information-Add.php" methd="POST">
