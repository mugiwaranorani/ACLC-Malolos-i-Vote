      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="containter-fluid overflow-auto" style="height: 403px;">
                ...
                <?php
                    $sql = "SELECT * FROM clg_userlog WHERE voterID LIKE '%{$search}%' OR logName LIKE '%{$search}%' OR logUSN LIKE '%{$search}%'  OR loginTime LIKE '%{$search}%' ORDER by loginTime DESC";
                ...
                <?php
                  ...
                  $query=mysqli_query($conn,"SELECT * FROM clg_userlog ORDER BY loginTime DESC");
                  $cnt=1;
