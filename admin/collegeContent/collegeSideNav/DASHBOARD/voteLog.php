      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="containter-fluid overflow-auto" style="height: 403px;">
                ...
                <?php
                    $sql = "SELECT * FROM clg_confirmedvote WHERE voterName LIKE '%{$search}%' OR dateConfirmedVote LIKE '%{$search}%' ORDER BY confirmedVoteID DESC";
                ...
                <?php
                  ...
                  $query=mysqli_query($conn,"SELECT * FROM clg_confirmedvote ORDER BY confirmedVoteID DESC");
