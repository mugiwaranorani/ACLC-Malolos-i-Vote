      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto" id="lockpage" style="height: 540px;">
              ...
              <?php			
                if (isset($_POST['saveDnT'])){
                include ('../../../../dbconn.php');
                      
                $dateTimePicker = $_POST['dateTimePicker'];
                
                $sql = "UPDATE `datetimedata` SET `dateTime`='$dateTimePicker' WHERE dtID = '1'";
                $result = $conn->query($sql);
                              
                  if ($result > 0) {
              ?>

                <div class="line-shadow p-3 mt-2">
                <h2><strong><b><i><i class='fa fa-clock-o' style='font-size:50px'></i> DATE AND TIME SAVE UPDATE</i></strong></b></h2>
                  <hr>
                  <br><i><h2 class="text-success" style="margin-top:-25px;">Date and time has been updated successfully!</i></h2>
                    ...
                    <a class="btn btn-primary px-4 mt-2" href="timeControl.php">Back</a>
