          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> ADD POSITION (SELECTION)</h3>
                <hr>
                  
                  <form action="candidate-add-position-result.php" method="post">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="positionSelect" name="positionSelect" placeholder="title here" value="" maxlength="14" required>
                      <label for="floatingInput">Position <span class="text-danger">(14)</span>:</label>
                    </div>

                    <input type="submit"  name="addPosInfoBtn" class="btn btn-success px-4" value="Add Content">
