          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> DELETE COURSE (SELECTION)</h3>
                <hr>
                    <?php			
                      include ('../../../../dbconn.php');
                      $id = $_REQUEST['id'];
                    ...
                    ?>
                    <span class='text-danger fs-5'>Are you sure you want to delete <span class="text-secondary fs-4 mt-2">"<?php echo $row['course']?>"</span> from course selection?</span>
                    <?php	
                      }		
                      $conn->close();
                      }
