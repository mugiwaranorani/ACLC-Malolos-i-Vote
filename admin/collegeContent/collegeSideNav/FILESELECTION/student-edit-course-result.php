          ...
          <div class="tab-pane fade show active p-3">
            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fas fa-file' style='font-size:30px'></i> COURSE (SELECTION)</h3>
                <hr>
                  ...
                  <form action="#" method="post">
                    ...
                    <?php			
                      ...
                      $id = $_REQUEST['id'];
                      $sql = "UPDATE `clg_courseselection` SET `course`='$course' WHERE courseID = $id";
                      $result = $conn->query($sql);
                              
                      if ($result > 0) {
                    ?>

                      <i><h2 class="text-success">Course has been updated successfully!</i></h2>
