              ...
              <div class="container line-shadow p-3">
                ...
                <hr>
                    ...
                    <?php
											...
											$yearLevelSelection = $_POST['courseSelect'];

											$sql = "INSERT INTO clg_courseselection (`course`)
											VALUES ('$yearLevelSelection')";
											
											if ($conn->query($sql)) {?>
											
												<i><h2 class="text-success">New course has been added to selection successfully!</i></h2>
