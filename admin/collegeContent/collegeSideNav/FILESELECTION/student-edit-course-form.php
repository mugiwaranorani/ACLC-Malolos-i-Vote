                ...
                <hr>
                  ...
                  <form action="student-edit-course-result.php" method="post">
                    ...
                    <?php			
                      include ('../../../../dbconn.php');
                      $id = $_REQUEST['id'];
                      $sql = "SELECT * FROM clg_courseselection WHERE courseID = $id";
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="courseSelect" maxlength="70" name="courseSelect" placeholder="title here" value="<?php echo $row['course']?>" required>
