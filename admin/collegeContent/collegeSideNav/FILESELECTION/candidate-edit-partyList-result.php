              ...
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <form action="#" method="post">
                    ...
                    <?php			
                      include ('../../../../dbconn.php');
                      $partyList = $_POST['partyListSelect'];
                      $id = $_REQUEST['id'];
                      $sql = "UPDATE `clg_plselection` SET `partyList`='$partyList' WHERE partyListID = $id";
                      $result = $conn->query($sql);
                              
                      if ($result > 0) {
                    ?>

                      <i><h2 class="text-success">Party list has been updated successfully!</i></h2>
