            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <?php
                    include '../../../../dbconn.php';
                    if(isset($_POST['deletePlInfoBtn'])){
                      $id = $_POST['id'];

                      $sql = "DELETE FROM clg_plselection WHERE partyListID = $id";
                      
                      if ($conn->query($sql) === TRUE) {
                  ?>
                      
                      <i><h2 class="text-success">Party list has been deleted successfully!</i></h2>
