            ...
            <br>
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <?php
                    include '../../../../dbconn.php';
                    if(isset($_POST['deletePosInfoBtn'])){
                      $id = $_POST['id'];

                      $sql = "DELETE FROM clg_positionselection WHERE positionID = $id";
                      
                      if ($conn->query($sql) === TRUE) {
                  ?>
                      
                      <i><h2 class="text-success">Position has been deleted successfully!</i></h2>
