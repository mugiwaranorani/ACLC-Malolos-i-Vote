              ...
              <div class="container home-content p-3">
                ...
                <hr class="mt-1">	
                  ...
                  <div class="nav nav-pills d-flex flex-column flex-sm-row overflow-auto fs-6" role="tablist" style="height:51px;">
                    <div class="nav-item">
                      <a class="nav-link active" href="systemGuide.php">Desktop Guide</a>
                    </div>
                    <div class="nav-item">
                      <a class="nav-link" href="systemGuide-Mobile.php">Mobile Guide</a>
                    </div>
                  </div>

                  <div>
                    
                    <?php include 'systemGuide-Desktop.php'; ?>
