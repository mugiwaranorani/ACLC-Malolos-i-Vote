      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="nav nav-pills d-flex flex-column flex-sm-row overflow-auto" role="tablist" style="height:51px;">
              ...
              <div class="nav-item">
                <a class="nav-link active" href="homeControl.php">Information</a>
              </div>
              <div class="nav-item">
            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">        
                ...
                <h3><i class='fas fa-file-alt' style='font-size:30px'></i> ADD INFORMATION TITLE AND CONTENT</h3>
                <hr>

                  <form action="information-Add-Result.php" method="post"  enctype="multipart/form-data">

                    <input type="hidden" class="form-control" id="hiddeninformationID" name="hiddeninformationID" placeholder="title here" value="information">

                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="infocontentheader" name="infocontentheader" placeholder="title here" value="" required>
                      <label for="floatingInput">Header Title:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <textarea class="form-control" rows="5" cols="20%" placeholder=">Write you content here" id="infocontent" name="infocontent" style="height: 250px" required></textarea>
                    ...
                    <input type="submit"  name="addinfoBtn" class="btn btn-success px-4" value="Add Content">
                    <a class="btn btn-danger px-4" href="homeControl.php">Cancel</a>
