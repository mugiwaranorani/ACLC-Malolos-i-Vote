          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">        
                ...
                <h3><i class='fas fa-edit' style='font-size:30px'></i> DELETE SYSTEM GUIDE TITLE AND CONTENT</h3>
                <hr>
                  ...
                  ?>
                    <span class='text-danger fs-5'>Are you sure you want to delete <span class="text-secondary fs-4">"<?php echo $row['contentHeader']?>"</span> from system guide?</span>
                    <?php	
                      }		
                      $conn->close();
                      }
                  ?> 
                    <form action="systemGuide-delete-result.php" method='post'>
                      <input class='btn btn-primary' type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>">
                      <button class="btn btn-success px-4 m-1 mt-2" name="deleteHomeSGBtn">Yes</button>
                      <a class='btn btn-danger px-4 m-1 mt-2' href='systemGuide.php'>No</a>
                    </form>
