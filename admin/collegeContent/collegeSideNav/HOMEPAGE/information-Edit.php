          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">        
                ...
                <h3><i class='fas fa-edit' style='font-size:30px'></i> EDIT INFORMATION TITLE AND CONTENT</h3>
                <hr>

                  <?php			
                    include ('../../../../dbconn.php');
                    $id = $_REQUEST['id'];
                    $sql = "SELECT * FROM clg_home WHERE homeID = $id";
                  ...
                  <form action="information-Edit-Result.php" method="post"  enctype="multipart/form-data">

                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="infocontentheader" name="infocontentheader" placeholder="title here" value="<?php echo $row['contentHeader']?>" required>
                      <label for="floatingInput">Header Title:</label>
                    </div>

                    <div class="form-floating mb-3">
                      <textarea class="form-control" rows="5" cols="20%" placeholder=">Write you content here" id="infocontent" name="infocontent" style="height: 250px" required><?php echo $row['content']?></textarea>
                    ...
                    <input type="submit"  name="editinfoBtn" class="btn btn-success px-4" value="Save">
                    <a class="btn btn-danger px-3" href="homeControl.php">Cancel</a>
