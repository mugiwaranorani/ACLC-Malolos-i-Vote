            ...
            <div class="container-fluid overflow-auto p-1" style="height: 500px;">
              ...
              <div class="container home-content p-3">        
                ...
                <?php
                  if (isset($_POST['addinfoBtn'])) {
                      ...
                      if (!empty($image)) {
                          ...
                          if (move_uploaded_file($image_tmp, $target_path)) {
                              $hcontentID = $_POST['hiddeninformationID'];
                              $contentHeader = $_POST['infocontentheader'];
                              ...
                              if ($conn->query($sql) === TRUE) {
                                  ?>
                                  <i><h2 class="text-success">New information content has been added successfully!</i></h2>
                                  <?php
                              } else {
                  ...
                  <a class="btn btn-primary px-4 mt-2" href="homeControl.php">BACK</a>
