          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container-fluid overflow-auto" style="height: 560px;">
              ...
              <div class="container line-shadow p-3">
                ...
                <h3><i class='fa fa-pencil-square-o' style='font-size:30px'></i> EDIT CANDIDATE</h3>
                <hr>
                  
                  <form action="candidate-edit-result.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="container text-center">
                      <label class="fs-5 mb-2">Please select an image again: </label><br>
                      <img id="preview" src="../../../../uploads/<?php echo $row['picture']?>" alt="" style="width: 300px; height: 350px; object-fit: cover;" class="mb-3 line-shadow">
                    ...
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="fname" name="fname" maxlength="18" placeholder="title here" value="<?php echo $row['name']?>" required>
                    ...
                    <!-- POSITION START -->
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="pos" name="pos" maxlength="14" placeholder="title here" value="<?php echo $row['position']?>" required>
                    ...
                    <!-- PARTY LIST START -->
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="pl" name="pl" maxlength="20" placeholder="title here" value="<?php echo $row['partyList']?>" required>
                      <label for="floatingInput">Party List <span class="text-danger">(20)</span>:</label>
                    </div>
                    <!-- PARTY LIST END -->

                    <!-- YEAR LEVEL START -->
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="yl" name="yl" maxlength="20" placeholder="title here" value="<?php echo $row['yearLvl']?>" required>
                    ...
                    <!-- COURSE START -->
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="crse" name="crse" maxlength="70" placeholder="title here" value="<?php echo $row['course']?>" required>
                      <label for="floatingInput">Course <span class="text-danger">(70)</span>:</label>
                    </div>
                    <!-- COURSE END -->
                    <div class="form-floating mb-3">
                      <textarea class="form-control" placeholder=">Write you content here" maxlength="5000" id="pf" name="pf" style="height: 200px" required><?php echo $row['platform']?></textarea>
                    ...
                    <input type="submit"  name="editCandidateBtn" class="btn btn-success px-4" value="Save">
                    <a class="btn btn-danger px-3" href="candidatesControl.php">Cancel</a>
