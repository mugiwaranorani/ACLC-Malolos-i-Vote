                ...
                <hr>
                    ...
                    if (isset($_POST['addCandidateBtn'])) {
                        ...
                        if (move_uploaded_file($image_tmp, $target_path)) {
                            ...
                            $sql = "INSERT INTO clg_candidates (name, position, partyList, yearLvl, course, platform, picture)
                                    VALUES ('$fname', '$position', '$partyList', '$yearLevel', '$course', '$platform', '$image')";
                    ...
                    <?php
                            ...
                            echo "<div style='color: red;'>Please upload photo..</div>";
                        }
