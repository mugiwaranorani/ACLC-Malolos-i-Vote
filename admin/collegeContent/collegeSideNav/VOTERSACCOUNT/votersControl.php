      ...
      <div class="col-sm-9">
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <div class="container p-2">
              <form action="voter-fullview.php" methd="POST">
                <button class="btn btn-outline-danger">View Voters Full Details</button>
              </form>
            </div>
            ...
            <div class="container-fluid overflow-auto" style="height: 448px;">
              ...
              <?php
                if (isset($_POST['searchbtn'])) {
                  ...
                  $sql = "SELECT * FROM clg_voter WHERE voterID LIKE '%{$search}%' OR fullName LIKE '%{$search}%' OR usn LIKE '%{$search}%'";
                  ...
                  <div class="container line-shadow p-3 mb-4">
                    ...
                    <a class="btn btn-outline-danger" href="votersControl.php">Clear Search</a>
                  </div>
