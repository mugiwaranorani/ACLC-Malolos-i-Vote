            ...
            <div class="container-fluid overflow-auto" style="height: 560px;">
              ...
              <div class="container line-shadow p-3">
                ...
                <hr>
                  ...
                  <?php
										include '../../../../dbconn.php';
										if (isset($_POST['addVoterAccountBtn'])) {
                    ...
                    $voterpassword = $_POST['voterpassword'];
										...
										$sql = "INSERT INTO clg_voter (`fullName`, `yearLevel`, `course`, `usn`, `vpass`)
										VALUES ('$fullname', '$yearlevel', '$course', '$usn', '$voterpassword')";
											
										if ($conn->query($sql)) {?>
											
											<i><h2 class="text-success">New voter account has been created successfully!</i></h2>
									...
									?>
										...
										<a class="btn btn-primary px-4 mt-2" href="votersControl.php">BACK</a>
