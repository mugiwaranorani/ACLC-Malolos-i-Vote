      ...
      <div class="col-sm-3 p-2">
        ...
        <div class="nav nav-pills flex-column bg-dark p-3 rounded" role="tablist">
          ...
          <div class="container-fluid overflow-auto" style="height: 550px;"> <!-- overflow-auto" style="height: 550px;" (insert inside if needed<--------------) -->
            ...
            <div class="nav-item">
              <a class="nav-link active" href="shs.php"><i class="fa fa-dashboard" style="font-size:18px"></i> Dashboard</a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/VOTES/votesReport.php"><i class="fas fa-vote-yea" style="font-size:17px"></i> Votes</a>
            </div>
            ...
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/FILESELECTION/candidate-selectionControl.php"><i class='fas fa-file' style='font-size:18px'></i> Canditate's Position & Party List</a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/FILESELECTION/student-selectionControl.php"><i class='fas fa-file' style='font-size:18px'></i> Student's Year Level & Strand</a>
            </div>
            <hr class="text-secondary">
            <!--FILE SELECTION END-->
            ...
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/HOMEPAGE/homeControl.php"> <i class="fa fa-home" style="font-size:22px"></i> Home Page</a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/CANDIDATESPAGE/candidatesControl.php"><i class="fas fa-id-card" style="font-size:18px"></i> Candidates</a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/VOTERSACCOUNT/votersControl.php"><i class="fa fa-group" style="font-size:18px"></i> Voters Account</a>
            </div>
            <hr class="text-secondary">
            <!--MANAGE END-->
            ...
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/ELECTIONTITLE/titleControl.php"><i class="fa fa-book" style="font-size:18px"></i> Election Title</a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="shsContent/shsSideNav/TIME/timeControl.php"><i class="fa fa-clock-o" style="font-size:19px"></i> Time</a>
            </div>
          ...
          <div class="tab-pane fade show active p-3">
            ...
            <hr>
              ...
              <div class="nav nav-pills d-flex flex-column flex-sm-row overflow-auto" role="tablist" style="height:51px;">
                ...
                <div class="nav-item">
                  <a class="nav-link active" href="../../../shs.php">Data Reports</a>
                </div>
                <div class="nav-item">
                  <a class="nav-link" href="shsContent/shsSideNav/DASHBOARD/userLog.php">User Log</a>
                </div>
                <div class="nav-item">
                  <a class="nav-link" href="shsContent/shsSideNav/DASHBOARD/voteLog.php">Vote Log</a>
                </div>
            ...
            <div class="containter-fluid overflow-auto" style="height: 500px;">
              ...
              <div class="con justify-content-around">
                ...
                <a href="shsContent/shsSideNav/VOTERSACCOUNT/votersControl.php" style="text-decoration: none;">
                ...
                <a href="shsContent/shsSideNav/CANDIDATESPAGE/candidatesControl.php" style="text-decoration: none;">
                  <div class="container p-3 bg-dark border border-light home-content text-light rounded text-center text_shadow dashcon m-5" style="width: 375px;">
                    <?php
                      include ('../dbconn.php');
                ...
                <a href="shsContent/shsSideNav/VOTERSACCOUNT/votersControl.php" style="text-decoration: none;">
                  <div class="container p-3 bg-dark border border-light home-content text-light rounded text-center text_shadow dashcon m-5" style="width: 375px;">
                      <div class="d-flex justify-content-between">
                        ...
                        <?php
                          include ('../dbconn.php');
                          $sql = "SELECT * FROM shs_voter WHERE voteStatus = 'Voted'";
                          $result = $conn->query($sql);
                          $count=$result->num_rows;	
                        ?>
