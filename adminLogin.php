      ...
      <img src="ACLCLOGO/sclogo2.png" class="sclogo" alt="School Logo"><img src="ACLCLOGO/aclc.png" class="sclogo2" alt="School Logo">
        ...
        <div class="container-fluid login-container p-3 rounded text-center">
          <form action="adminLoginProcess.php"method="POST">
            <h1 class="mb-3"><b>ADMIN LOGIN</b></h1>
            ...
            <div class="d-flex justify-content-center">
              ...
              <div class="form-floating mb-3" style="margin-right: 35px;">
                <input type="password" class="form-control" name="vpass" placeholder="Password" value="" id="passwordInput" required>
                <label for="floatingInput">PASSWORD</label><!--<span id="togglePassword" onclick="togglePasswordVisibility()" style="font-size: 30px;">&#128065;</span>-->
              </div>
            </div>
            ...
            <a href="index.php" class="back-btn btn btn-danger mx-1 fs-4 px-4">i-Vote</a>
          </form>
        </div>
...
<script>
  function togglePasswordVisibility() {
      ...
      if (passwordInput.type === "password") {
          ...
          togglePassword.innerHTML = "&#128064;"; // Show password icon
      } else {
          passwordInput.type = "password";
          togglePassword.innerHTML = "&#128065;"; // Hide password icon
      }
  }
</script>
-->