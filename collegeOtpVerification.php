...
<html lang="en">
  <head>
    ...
    <title>College Verification Login</title>
      ...
      <img src="ACLCLOGO/sclogo2.png" class="sclogo" alt="School Logo"><img src="ACLCLOGO/aclc.png" class="sclogo2" alt="School Logo">
        ...
        <div class="container-fluid login-container p-3 rounded text-center">
          <form action="collegeLoginProcess.php"method="POST">
            <h1 class="mb-3"><b>COLLEGE LOGIN</b></h1>

            <div class="d-flex justify-content-center">
              <i class="fas fa-key mt-2 fs-2 mx-2"></i>
              <div class="form-floating mb-3" style="margin-right: 35px;">
                <input type="text" class="form-control" name="VerifyCode" placeholder="verifyCode" value="" maxlength = "5" required>
            ...
            <a href="collegeLogin.php" class="back-btn btn btn-danger mx-1 fs-4 px-4">Back</a>
          </form>
        </div>
